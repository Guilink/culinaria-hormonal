...
Foque em ingredientes que trazem beneficios para a saude e são fáceis de encontrar.
A receita pode ser lanches rápidos, cafés, sobremesa, almoço, janta, etc... você pode olhar o historico e ir alternando as receitas.
...
- EXEMPLOS:
  ...
  • "Esse ___ que melhorou minha ___"

- Use gatilhos de curiosidade e benefício:
  poder, segredo, espanta, energia, memória, sono, cansaço,
  diferente, melhorou, curou, troquei, que poucos conhecem

- NÃO usar títulos longos ou explicativos demais
- Usar linguagem natural e simples, com baixa carga cognitiva
...
- prompt_prato_pronto: hero shot apetitoso do prato finalizado vistoso de dar agua na boca
